...
export default function TaxCertificateScreen() {
  ...
  const handleDownload = async () => {
    try {
      ...
      const fileName = `tax-certificate-${timestamp}.jpg`;
      ...
      if (await Sharing.isAvailableAsync()) {
        await Sharing.shareAsync(fileUri, {
          mimeType: 'image/jpeg',
          dialogTitle: 'Save Tax Certificate',
        });
      } else {
        Alert.alert('Success', `Tax certificate saved to: ${fileUri}`);
      }
    } catch (error) {
      console.error('Download error:', error);
      Alert.alert('Error', 'Failed to download tax certificate. Please try again.');
    } finally {
      ...
      >
        ...
        <View style={[styles.infoCard, { backgroundColor: colors.card }]}>
          ...
          <Text style={[styles.infoDescription, { color: colors.textSecondary }]}>
            This is your official Tax Identification Number (TIN) certificate issued by the National Board of Revenue.
          </Text>
        </View>
        ...
        <View style={[styles.downloadCard, { backgroundColor: colors.card }]}>
          ...
          <Text style={[styles.downloadDescription, { color: colors.textSecondary }]}>
            Download a copy of your tax certificate for your records or official use.
          </Text>
